...
const SideBody: QuartzComponent = ({ fileData, displayClass }: QuartzComponentProps) => {
  ...
  if (home) {
	   return <h1 class={classNames(displayClass, "side-body")}>		<iframe src="https://bestvibes.me/quote-of-the-day" title="QOTD" style="border:2px solid white;" height="300" width="300" ></iframe>		</h1>
  } else {
	  return null
  }
}
